    ...
    <aside className="h-fit rounded-lg border border-line bg-ivory p-6">
      ...
      {totals ? (
        <div className="mt-5 space-y-2 border-t border-line pt-4">
          ...
          <div className="flex justify-between border-t border-line pt-3 font-display text-lg text-charcoal">
            <span>Total</span>
        ...
        <p className="mt-5 border-t border-line pt-4 text-sm text-charcoal/50">
