...
export default function NotFound() {
  return (
    <div className="container-page flex min-h-[50vh] flex-col items-center justify-center text-center">
      <p className="font-display text-7xl text-whisky-300">404</p>
      <h1 className="mt-4 font-display text-[1.75rem] tracking-tightest text-charcoal">We couldn&apos;t find that page</h1>
