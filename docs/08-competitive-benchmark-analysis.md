...
| Dimension | Analysis |
|-----------|----------|
| **Business model** | Specialist online + physical retailer (3 London stores: Covent Garden, Great Portland St, London Bridge), on-trade supply, private sales, and rare-spirit auctions. ~£70m revenue at acquisition. Founded by the Singh brothers from a 1999 mail-order business. |
| **Revenue streams** | 1P retail (bottles across whisky, champagne, cognac, rum, gin, tequila/mezcal), physical retail, on-trade B2B, auctions/private sales of rare spirits, events/tastings. |
| **Catalogue** | ~10,000 SKUs (≈4,000 whiskies + champagnes, cognacs, rums, gins, etc.). Deep in rare/collectible. Strong own-curation and exclusives. |
| **Navigation** | Category + region + brand + price navigation; strong editorial curation ("staff picks," guides). Clean, premium, brand-forward. |
| **Search/filter** | Solid faceted filtering (region, age, price, flavour). Competent but not remarkable; not strongly AI/semantic. |
| **UX** | Premium, polished, editorial. Among the best-looking in the category. Strong product photography and storytelling. |
| **Customer journey** | Discovery-led via content + curation; strong gifting; events funnel. Conversion via trust + selection + brand prestige. |
| **Checkout** | Standard, competent multi-step; age confirmation; UK + international shipping. Not notably differentiated. |
| **Membership/loyalty** | Historically weaker on formal membership/loyalty vs. Whisky Shop; relies on brand + newsletter + curation rather than a points program. |
| **Content** | Strong editorial (guides, distillery features, "The Whisky Exchange Blog"), tasting events (Whisky Show). High authority. |
| **SEO** | Very strong domain authority; ranks well on category + brand + buying-intent terms. Long-standing backlinks. |
| **Mobile** | Responsive, premium; functional rather than app-led. |
| **Personalisation** | Limited/basic (recently viewed, recommendations). Not a personalisation leader. |
| **Tech** | Custom/enterprise commerce stack; now within Pernod Ricard's infrastructure. Mature but not bleeding-edge. |
| **Funnels/CRO** | Content + curation + email + events. Premium positioning over discounting. |

**Strengths:** brand prestige, catalogue depth (esp. rare), editorial authority, omnichannel, Pernod's capital/supply.
**Weaknesses:** **owned by a supplier → conflict of interest** (incentive to favour Pernod brands; independence perception lost); slower innovation as a conglomerate asset; weak formal loyalty/community; limited AI/personalisation; not a marketplace.
...
| **UX** | Feature-rich but **visually ageing**; information-dense; less premium-feeling than TWE. Quirky brand voice (humour). |
| **Customer journey** | Discovery via samples + content + huge range; sampling de-risks trial → full-bottle conversion. Strong gifting (advent calendars, engraving). |
...
| **Funnels/CRO** | Sampling as a trial funnel; advent calendars as seasonal acquisition; content/SEO as evergreen acquisition; reviews as social proof. |

**Strengths:** **sampling innovation** (huge moat for discovery + trial), catalogue breadth, SEO dominance, own brands (margin), advent-calendar seasonal engine, distinctive voice.
**Weaknesses:** **dated UX/visual design**; density/overwhelm; weaker premium feel; limited personalisation/AI; no real community/marketplace; loyalty less developed than Whisky Shop.
...
| Dimension | Analysis |
|-----------|----------|
| **Business model** | Bricks-and-clicks specialist chain (20+ UK stores) + online + auctions + membership. Retail-led with a strong loyalty engine. |
| **Revenue streams** | 1P retail (stores + online), **The W Club** membership (free + premium tiers), **Whisky Shop Auctions**, exclusive bottlings, **Whiskeria** magazine, tastings/events, gifting. |
| **Catalogue** | Broad whisky + spirits range; strong on exclusives and premium/collectible; auction channel for secondary market. |
| **Navigation** | Category/region/brand/price; membership and club deeply integrated into nav and PDP (member pricing). |
| **Search/filter** | Standard faceted search/filtering; competent. |
...
| **Personalisation** | Membership/profile-based perks; limited AI personalisation. |
| **Tech** | Magento-class / enterprise retail platform (omnichannel POS + ecommerce). Mature retail tech. |
| **Funnels/CRO** | Membership as the central funnel + retention loop; ballots/exclusives for engagement; auctions for the secondary market; in-store ↔ online crossover. |

**Strengths:** **loyalty/membership** (the clearest, most rewarding program), omnichannel (stores + online + click-and-collect), ballots/allocations for engagement, integrated auctions, magazine/brand.
**Weaknesses:** retail-bound (not a platform); weaker online authority/content scale than TWE/MoM; limited AI/personalisation/community-at-scale; UX/tech is competent-retail rather than best-in-class digital.
...
| Capability | TWE | Master of Malt | Whisky Shop | **WhiskyMart (target)** |
|------------|:--:|:--:|:--:|:--:|
| Premium UX / brand | ●●● | ●● | ●● | **●●●** |
| Catalogue depth | ●●● | ●●● | ●● | **●●●** |
| Sampling | ● | ●●● | ● | **●●●** |
...
| Membership tiers | ● | ●● | ●●● | **●●●** |
| Community / forums | ○ | ● | ● | **●●●** |
| Content / SEO authority | ●●● | ●●● | ●● | **●●●** (built over time) |
| Marketplace (3P) | ○ | ○ | ○ | **●●●** |
| Auctions | ●● | ○ | ●● | **●●●** |
| Cask / investment | ● | ○ | ● | **●●●** |
| **Authenticity / provenance** | ● | ○ | ● | **●●●** |
| **Unified buy→collect→invest** | ○ | ○ | ○ | **●●●** |
| Independence (not supplier-owned) | ✗ (Pernod) | ✓ | ✓ | **✓** |

● scale of strength · ○ absent
...
*Continue to → [09 Compliance & Regulatory Dossier](09-compliance-and-regulatory.md)*
