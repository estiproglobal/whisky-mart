...
WhiskyMart.com sits deliberately at the intersection of three worlds that incumbents keep separate:

```
            RETAIL  (buy with confidence)
               │
               ▼
   CONTENT ◀──── WHISKYMART ────▶ COMMUNITY
   (learn)       (trust + AI)      (belong)
               ▲
               │
...
## 4. Value proposition (by who we serve)

| We help… | …do this | …better than anyone because |
|----------|----------|----------------------------|
| **Newcomers** | Find a whisky they'll love without feeling stupid | AI Sommelier + samples + plain-English education |
| **Enthusiasts** | Deepen the hobby and discover rare bottles | Deep catalogue, tasting notes, clubs, recommendations |
| **Gift buyers** | Buy the perfect present, fast | Gift Finder AI, curated packs, concierge, gift messaging |
| **Collectors** | Build, track, authenticate, and trade collections | WhiskyVault + verified marketplace + provenance layer |
| **Investors** | Access whisky as an asset class with transparency | Cask/bottle investment, valuation data, custody |
| **Sellers/Brands** | Reach a global, qualified audience | Marketplace + distillery storefronts + retail media |
...
| Persona | P1 Store | P2 Discovery | P3 Community | P4 Marketplace/Invest | P5 AI |
|---------|:--:|:--:|:--:|:--:|:--:|
| Cara | ●●● | ●●● | ● | – | ●●● |
| Ewan | ●● | ●●● | ●●● | ●● | ●●● |
| Grace | ●●● | ●● | – | – | ●●● |
...
### Revenue mix evolution (illustrative target)

| Stream | Yr 1 | Yr 2 | Yr 3 |
|--------|:--:|:--:|:--:|
| 1P retail | 92% | 70% | 48% |
| Marketplace | – | 10% | 22% |
| Membership | 3% | 8% | 10% |
| Sampling/boxes | 4% | 6% | 6% |
| Auction/investment | – | 3% | 8% |
| Retail media/partnerships | 1% | 2% | 4% |
| Data products | – | 1% | 2% |

The strategic shift from **margin-on-goods** to **margin-on-platform** (marketplace + media + data) is what transforms valuation from a retailer multiple (~1–2× revenue) to a platform multiple (5–10×+).

## 7. Unit economics (illustrative MVP-era targets)

| Metric | Target | Notes |
|--------|--------|-------|
| Average Order Value (AOV) | £75–£120 | Bottles skew high; samples lower; gifts higher |
| Gross margin (blended, 1P) | 25–30% | Improves with own-label + exclusives |
| CAC (paid) | £18–£35 | Improves sharply with SEO/content/referral |
| Repeat purchase rate (12 mo) | 35–45% | Membership + AI personalisation lever |
| Customer Lifetime Value (3 yr) | £350–£900 | Collectors/investors far higher |
| LTV:CAC | >3:1 (target >5:1) | The north-star efficiency metric |
| Contribution margin per order | 12–18% | After fulfilment, payment, returns |

## 8. Marketplace economics (Phase 4 detail)

A two-sided marketplace lives or dies on **liquidity** and **trust**. Our levers:
...
## 10. Global expansion roadmap

Whisky is global, but **alcohol law is brutally local** (see [Compliance Dossier](09-compliance-and-regulatory.md)). Expansion is therefore **compliance-gated**, not ambition-gated.

| Wave | Markets | Rationale | Key challenges |
|------|---------|-----------|----------------|
...
5. **Global, compliant operating capability** in a hard-to-operate category.

The TWE→Pernod deal proves the appetite exists. Our job is to be the asset that commands a **platform multiple, not a retailer multiple.**

---

*Continue to → [02 Product Architecture](02-product-architecture.md)*
